...
class Apanel extends CI_Controller{
	...
	function noticeBoard(){
		...
		$data['smallTitle'] = "noticeBoard";
		$data['pageTitle'] = "Students notice Board List";
	...
	function download(){
		...
		$data['subPage'] = 'Website';
		$data['title'] = "Download";
		$data['smallTitle'] = "Download";
		$data['pageTitle'] = " Download";
		$data['mainContent'] = "download";
		$data['headerCss'] = "headerCss/studentListCss";
		$data['footerJs'] = "footerJs/studentListJs";
		$this->load->view("include/template",$data);
	}
