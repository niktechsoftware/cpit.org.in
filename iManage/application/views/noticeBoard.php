                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                            	...
                            	<?php $deta = $this->db->get("notice")->row();?>
                                   <form class="form-horizontal" action="<?php echo base_url()?>allform/editHeadline" method="post">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                	...
                                                	<a href="<?php echo base_url();?>allform/deleteHeadline/<?php echo $row->id;?>">Delete</a>
                                                </td>
                                            </tr>
                                            <?php $i++;?>
                                            <?php endforeach;?>
