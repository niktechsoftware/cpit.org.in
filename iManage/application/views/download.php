                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                            	<div class="panel-body">
                            		<div class="row">
                            			<div class="col-md-12">
                            				<form class="form-horizontal" action="<?php echo base_url()?>allform/saveDownload" method="post" enctype="multipart/form-data">
                                    ...
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url();?>assets/images/download/<?php echo $row->image; ?>" target="_blank">Download</a></td>
                                                <td><?php echo $row->date; ?></td>
                                                <td>
                                                	<a href="<?php echo base_url();?>allform/deleteDownload/<?php echo $row->sno;?>/<?php echo $row->image;?>">
                                                		Delete
                                                	</a>
                                                </td>
                                            </tr>
